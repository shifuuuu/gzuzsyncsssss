...
ui_new_label("AA", "Anti-aimbot angles", "-----------[GzuzSync]-----------")
local master_switch = ui_new_checkbox("AA", "Anti-aimbot angles", "Enable")
local master_box = ui_new_combobox("AA", "Anti-aimbot angles", "config", "AA", "DT ENHANCEMENT", "VISUALS")
local override_antiaim = ui_new_checkbox("AA", "Anti-aimbot angles", "Enable ANTIAIM")
--local reset_stages = ui_new_hotkey("AA", "Anti-aimbot angles", "Reset bruteforce stages")
local adaptive_fs = ui_new_checkbox("AA", "Anti-aimbot angles", "APDATIVE FREESTAND")
local manual_aa = ui_new_checkbox("AA", "Anti-aimbot angles", "[M] MANUAL AA")
local manual_aa_clr = ui_new_color_picker("AA", "Anti-aimbot angles", "[M] MANUAL AA", 255, 255, 255, 255)
local manual_left = ui_new_hotkey("AA", "Anti-aimbot angles", "[M]Left")
local manual_right = ui_new_hotkey("AA", "Anti-aimbot angles", "[M]Right")
local manual_state = ui_new_slider("AA", "Anti-aimbot angles", "Manual direction", 0, 2, 0)
local faster_dt = ui_new_checkbox("AA", "Anti-aimbot angles", "RAPID DOUBLETAP")
local adaptive_dt = ui_new_checkbox("AA", "Anti-aimbot angles", "DYNAMIC SHIFT")
local legit_aa_use = ui_new_checkbox("AA", "Anti-aimbot angles", "LEGIT AA ON USE")
local low_deltakey = ui_new_hotkey("AA", "Anti-aimbot angles", "LOW DELTA ON KEY")
...
local GzuzSync_clr = ui_new_label("AA", "Anti-aimbot angles", "GzuzSync color")
local shandy_yaw_clr = ui_new_color_picker("AA", "Anti-aimbot angles", "GzuzSync color", 255, 255, 255, 255)
local hide_clr = ui_new_label("AA", "Anti-aimbot angles", "hideshot color")
local hide_color = ui_new_color_picker("AA", "Anti-aimbot angles", "Hide shot indicator color", 255, 255, 255, 255)
ui_new_label("AA", "Anti-aimbot angles", "-----------[GzuzSync]-----------")
